...
class DataClassArgumentParserTest(unittest.TestCase):
    def argparsersEqual(self, a: argparse.ArgumentParser, b: argparse.ArgumentParser):
        ...
        for x, y in zip(a._actions, b._actions):
            xx = {k: v for k, v in vars(x).items() if k != "container" and k != "type"}
            yy = {k: v for k, v in vars(y).items() if k != "container" and k != "type"}
    ...
    def test_with_default(self):
        parser = DataClassArgumentParser(WithDefaultExample)
    ...
    def test_with_default_bool(self):
        parser = DataClassArgumentParser(WithDefaultBoolExample)
    ...
    def test_with_enum(self):
        parser = DataClassArgumentParser(EnumExample)
    ...
    def test_with_list(self):
        parser = DataClassArgumentParser(ListExample)
    ...
    def test_with_optional(self):
        parser = DataClassArgumentParser(OptionalExample)
    ...
    def test_with_required(self):
        parser = DataClassArgumentParser(RequiredExample)
    ...
    @pytest.mark.skip(reason="Migrated from HuggingFace Transformers")
